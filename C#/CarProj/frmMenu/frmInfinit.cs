...
namespace frmMenu
{
    public partial class frmInfinit : Form
    {
        double basePrice = 0;
        ...
        private void frmInfinit_Load(object sender, EventArgs e)
        {
        ...
        private void rdbCar1_CheckedChanged_1(object sender, EventArgs e)
        {
            grpOpt.Visible = rdbCar1.Checked;

            if (rdbCar1.Checked)
                basePrice = basePrice + 47000;
            else
                basePrice = 0;
            lblPrice.Text = basePrice.ToString("C");
            Calculate();
        ...
        private void rdbCar2_CheckedChanged_1(object sender, EventArgs e)
        {
            grpOpt.Visible = rdbCar2.Checked;

            if (rdbCar2.Checked)
                basePrice = basePrice + 54000;
            else
                basePrice = 0;
            lblPrice.Text = basePrice.ToString("C");
            Calculate();
        ...
        private void rdbCar3_CheckedChanged_1(object sender, EventArgs e)
        {
            grpOpt.Visible = rdbCar3.Checked;

            if (rdbCar3.Checked)
                basePrice = basePrice + 57000;
            else
                basePrice = 0;
            lblPrice.Text = basePrice.ToString("C");
            Calculate();
        ...
        private void rdbCar4_CheckedChanged_1(object sender, EventArgs e)
        {
        ...
        private void rdbCar5_CheckedChanged_1(object sender, EventArgs e)
        {
        ...
        private void rdbCar6_CheckedChanged_1(object sender, EventArgs e)
        {
            grpOpt.Visible = rdbCar6.Checked;

            if (rdbCar6.Checked)
                basePrice = basePrice + 58000;
            else
                basePrice = 0;
            lblPrice.Text = basePrice.ToString("C");
            Calculate();
