...
namespace frmMenu
{
    public partial class frmAcura : Form
    {
        double basePrice = 0;
        ...
        private void frmAcura_Load(object sender, EventArgs e)
        {
